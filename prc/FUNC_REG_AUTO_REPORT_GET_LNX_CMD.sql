...
RETURNS @RESULT TABLE (
						...
						ServerRemoto 	 VARCHAR(256),
						UsuarioSftp 	 VARCHAR(256),
						CertificadoSftp  VARCHAR(256),
						PathRemoto		 VARCHAR(256)	--FM202602
)
AS
BEGIN 
/*
...
******************************************************************************************************
Descripcion	:	Se ajusta la funcion para que retorne el parametro PathRemoto
Autor		:	Fredy Miranda
Fecha		: 	2026-02
Empresa		: 	TCM PARTNERS
Tag			:	FM202602
...
*/
	...
	SELECT
		...
		@ServerRemoto 	 = MAX(CASE WHEN Param_Name = 'ServerRemoto'    THEN Param_Value END),
		@UsuarioSftp 	 = MAX(CASE WHEN Param_Name = 'UsuarioSftp'     THEN Param_Value END),
		@CertificadoSftp = MAX(CASE WHEN Param_Name = 'CertificadoSftp' THEN Param_Value END),
		@PathRemoto 	 = MAX(CASE WHEN Param_Name = 'PathRemoto' 		THEN Param_Value END)	--FM202602
    ...
    INSERT INTO @RESULT (LinuxCmd, PathOutput, FileName, ServerRemoto, UsuarioSftp, CertificadoSftp, PathRemoto)	--FM202602
    VALUES (@LinuxCmd, @PathOutput, @FileName, @ServerRemoto, @UsuarioSftp, @CertificadoSftp, @PathRemoto);			--FM202602
